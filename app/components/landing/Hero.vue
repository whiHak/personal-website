...
<template>
    <section
        ...
        <div class="absolute top-20 md:top-30 left-5 2xl:left-25 flex flex-row md:flex-col gap-4 md:gap-8 z-30">
            <NuxtLink to="https://www.linkedin.com/in/betselot-abraham-184753285/" target="_blank" aria-label="LinkedIn" class="group">
            ...
            <NuxtLink to="https://x.com/betse_ab" target="_blank" aria-label="Twitter" class="group">
            ...
            <NuxtLink to="https://github.com/whiHak" target="_blank" aria-label="GitHub" class="group">
            ...
            <NuxtLink to="https://www.instagram.com/betse_ab" target="_blank" aria-label="Instagram" class="group">
        ...
        <div class="relative mx-auto">
            <div
                ...
                <div class="2xl:px-20 sm:px-10 py-10 mt-20 lg:mt-10  md:py-16 2xl:py-32 z-30">
